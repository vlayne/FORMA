...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 03 Décembre 2015 à 10:27
...
INSERT INTO `stagiaire` (`ID_UTIL`, `NUM_ICOM`, `NOM_UTIL`, `PRENOM_UTIL`, `STATUT`, `FONCTION`, `grade`, `mdp`) VALUES
(1, 98495494, 'Pradines', 'Gautier', 'Bénévole', NULL, 'a', '0000'),
(2, 98495494, 'Nady', 'Youness', 'Salarié', NULL, 'b', '0000');
